...
public class Fragment_RootSecond_PagerSecond extends SupportFragment {
    ...
    private void initArticleThumbnailList() {
        articleThumbnailList = new JsonUtil().getArticles(mContext, INFORM_ARTICLE);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView1 = (RecyclerView) v.findViewById(R.id.recyclerview_articlethumbnail_2);
